...
export interface ConnectaNftInterface extends utils.Interface {
...
export interface ConnectaNft extends BaseContract {
  contractName: "ConnectaNft";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectaNftInterface;
  ...
  functions: {
    ...
    token(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
