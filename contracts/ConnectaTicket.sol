...
error ConnectaTicket__ProposalRejected();
error ConnectaTicket_ClaimedNotPossible();

/**
 * @title ConnectaTicket - A Collaborative Crowdfunding NFT Smart Contract
 ...
 */
contract ConnectaTicket is Context, ERC721Enumerable, ReentrancyGuard {
    ...
    modifier onlyOperator() {
        require(
            ...
            "ConnectaTicket: User is not authorized"
        );
        _;
    }
    ...
    modifier onlyProposalCreator() {
        require(
            ...
            "ConnectaTicket: User is not proposal creator"
        );
        _;
    }
    ...
    modifier onlyWhenProposalIsNotActive() {
        require(
            ...
            "ConnectaTicket: Funding has been intiated , action cannot be performed"
        );
        _;
    }
    modifier onlyWhenNotPaused() {
        require(pause == false, "ConnectaTicket: Funding is paused!");
        _;
    }
    ...
    constructor(
        ...
        require(
            ...
            "DreamStarter: Invalid Proposal Input"
        );
        ...
        require(
            ...
            "DreamStarter: Invalid Contract Input"
        );
    ...
    function _transferFunds(
        ...
        require(value >= amount, "ConnectaTicket: Not Enough Funds!");
        bool success;
        if (from == address(this)) {
            success = token.transfer(to, amount);
            require(success, "ConnectaTicket: Transfer failed");
        } else {
    ...
    function intiateRejection() external {
        require(
            ...
            "ConnectaTicket: Rejection cannot be done"
        );
        _proposalRejection();
    ...
    function stake(
        ...
        require(
            ...
            "ConnectaTicket: Funds should be equal to staking amount"
        );
        require(
    ...
    function mintTicket() external returns (uint256) {
        require(
            ...
            "ConnectaTicket : Proposal is being rejected"
        );
        require(
            block.timestamp >= fundingActiveTime &&
                block.timestamp < fundingEndTime,
            "ConnectaTicket: Funding time has been passed"
        );
        if (isCreatorStaked == false) {
            _proposalRejection();
            revert ConnectaTicket__ProposalRejected();
        }
        require(
            fundsInReserve < crowdFundingGoal,
            "ConnectaTicket: Funding goal has been reached"
        );
    ...
    function withdrawFunds(
        ...
        require(
            ...
            "ConnectaTicket: Amount to be collected more than staked"
        );
        require(
            fundsInReserve >= amount,
            "ConnectaTicket: Process cannot proceed , less than reserve fund"
        );
        fundsInReserve -= amount;
        _pause();
   ...
   /**
    ...
    function claimback(
        ...
        require(
            ...
            "DreamStarter: Refund is already claimed!"
        );
        if (
            ...
            revert ConnectaTicket_ClaimedNotPossible();
        }
    }
    ...
    function unStake() external onlyProposalCreator returns (uint256 amount) {
        require(
            ...
            "DreamStarter: User cannot withdraw funds"
        );
    ...
    function tokenURI(
        ...
        require(_exists(tokenId), "ConnectaTicket: Non-Existent Asset");
        return baseURI;
    }
